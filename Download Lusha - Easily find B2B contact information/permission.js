...
/* harmony import */ var _frame_js_content_utils_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1);
/* harmony import */ var _frame_js_shared_MessageBroker__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(84);
/* harmony import */ var _frame_js_content_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(16);
/* harmony import */ var _frame_js_content_utils_iframe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7);
/* harmony import */ var _frame_js_content_utils_Storage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6);
/* harmony import */ var _frame_js_content_scout_constants__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(11);
...
var optionalPermission = /*#__PURE__*/function () {
  function optionalPermission() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, optionalPermission);
    var _parseQueryParams = Object(_frame_js_content_utils__WEBPACK_IMPORTED_MODULE_4__[/* parseQueryParams */ "b"])(document.location.search),
      platform = _parseQueryParams.platform,
      openerTab = _parseQueryParams.openerTab;
    this.onPostMessageReceived = this.onPostMessageReceived.bind(this);
    this.platform = platform;
    this.openerTab = parseInt(openerTab, 10);
    this.render();
  }

  // on post message received
  return _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(optionalPermission, [{
    key: "onPostMessageReceived",
    value: function onPostMessageReceived(msg) {
      switch (msg.data.type) {
        case 'ASK_PERMISSIONS':
          this.askPermission();
          break;
        case 'PERMISSIONS_UPDATED':
          this.permissionsUpdated(msg);
          break;
        default:
          break;
      }
    ...
    // Ask run time host permissions.
  }, {
    key: "askPermission",
    value: function askPermission() {
      var _this = this;
      var permissions = this.getPermission();
      chrome.permissions.request(permissions).then(function (granted) {
        var isAllWebsitesOrigin = permissions.origins.includes('*://*/*');
        if (granted) {
          _this.injectScripts();
          if (isAllWebsitesOrigin) {
            _frame_js_content_utils_Storage__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"].set(_frame_js_content_scout_constants__WEBPACK_IMPORTED_MODULE_7__[/* IS_ALL_WEBSITES_PERMISSIONS_GRANTED_KEY */ "a"], true);
          }
          if (_this.platform === _frame_js_content_utils_constants__WEBPACK_IMPORTED_MODULE_2__[/* FRAME_PLATFORMS */ "d"].SCOUT) {
            _this.platform === _frame_js_content_utils_constants__WEBPACK_IMPORTED_MODULE_2__[/* FRAME_PLATFORMS */ "d"].SCOUT && _frame_js_content_utils_Storage__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"].set(_frame_js_content_scout_constants__WEBPACK_IMPORTED_MODULE_7__[/* IS_SCOUT_ENABLED_KEY */ "b"], true);
            chrome.tabs.get(_this.openerTab, function (openerTab) {
              var url = new URL(openerTab.url);
              url.searchParams.set('autoopen', 'true');
              chrome.tabs.update(_this.openerTab, {
                active: true,
                url: url.toString()
              });
            });
          } else if (_this.platform === _frame_js_content_utils_constants__WEBPACK_IMPORTED_MODULE_2__[/* FRAME_PLATFORMS */ "d"].CALENDAR || _this.platform === _frame_js_content_utils_constants__WEBPACK_IMPORTED_MODULE_2__[/* FRAME_PLATFORMS */ "d"].OUTLOOK_CALENDAR) {
            Object(_frame_js_content_utils_iframe__WEBPACK_IMPORTED_MODULE_5__[/* postMessageToIframe */ "a"])({
              type: 'PERMISSIONS_GRANTED',
              payload: {
                platform: _this.platform,
                isAllowed: true
              }
            }, {}, 'LU__extension_iframe_permission');
            return;
          } else {
            chrome.tabs.reload(_this.openerTab);
          }
          _this.closeWindow();
          window.removeEventListener('message', _this.onPostMessageReceived);
        } else if (_this.platform === _frame_js_content_utils_constants__WEBPACK_IMPORTED_MODULE_2__[/* FRAME_PLATFORMS */ "d"].CALENDAR || _this.platform === _frame_js_content_utils_constants__WEBPACK_IMPORTED_MODULE_2__[/* FRAME_PLATFORMS */ "d"].OUTLOOK_CALENDAR) {
          Object(_frame_js_content_utils_iframe__WEBPACK_IMPORTED_MODULE_5__[/* postMessageToIframe */ "a"])({
            type: 'PERMISSIONS_GRANTED',
            payload: {
    ...
    // Get host permission definition.
  }, {
    key: "getPermission",
    value: function getPermission() {
      switch (this.platform) {
        case _frame_js_content_utils_constants__WEBPACK_IMPORTED_MODULE_2__[/* FRAME_PLATFORMS */ "d"].CALENDAR:
          return {
    ...
    value: function permissionsUpdated() {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        data = _ref.data;
      var refreshTab = data.payload.refreshTab;
      if (refreshTab) {
        chrome.tabs.reload(this.openerTab);
        this.closeWindow();
        window.removeEventListener('message', this.onPostMessageReceived);
      }
    }

    // Called upon user approval/denial of permission.
  }, {
    key: "onPermission",
    value: function onPermission(granted) {
      if (granted) {
        this.injectScripts();
        this.closeWindow();
      }
    ...
    // Close the current permission window.
  }, {
    key: "closeWindow",
    ...
    // Call the background to inject scripts to the opener tab by platform.
  }, {
    key: "injectScripts",
    value: function injectScripts() {
      Object(_frame_js_shared_MessageBroker__WEBPACK_IMPORTED_MODULE_3__[/* sendMessage */ "a"])('injectScripts', {
        platform: this.platform,
        tabId: this.openerTab
      }, function () {
        return true;
      });
    }
    ...
    value: function render() {
      ...
      var url = "".concat(_frame_js_content_utils_constants__WEBPACK_IMPORTED_MODULE_2__[/* FRAME_ADDRESS */ "b"], "/enable-permissions?platform=").concat(this.platform, "&openerTab=").concat(this.openerTab, "&version=").concat(version);
      el.innerHTML = "<iframe width=\"100%\" height=\"100%\" style=\"position:absolute\" frameBorder=\"0\" id='LU__extension_iframe_permission' lang=\"en\" src=\"".concat(url, "\" ></iframe>");
      document.body.append(el);
      $(document.body).append($('<style> html, body { margin: 0 }</style>'));
      window.addEventListener('message', this.onPostMessageReceived);
    }
  }]);
}();
new optionalPermission();
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(10)))
...
/* unused harmony export sendMessageToActiveTab */
var sendMessage = function sendMessage(action, payload, handleResponse) {
...
var sendMessageToActiveTab = function sendMessageToActiveTab(action, handleResponse) {
  chrome.tabs.query({
    active: true,
    currentWindow: true
  }, function (tabs) {
    var activeTab = tabs.length ? tabs[0] : null;
    if (activeTab) {
      chrome.tabs.sendMessage(activeTab.id, action, handleResponse);
    }
  });
};
