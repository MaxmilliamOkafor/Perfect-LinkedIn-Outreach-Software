...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(30);
...
var Platform = /*#__PURE__*/function () {
  ...
  return _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(Platform, null, [{
...
/* harmony import */ var detect_browser__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(33);
...
/* harmony import */ var _toolbar_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(34);
...
var onToolbarIframeMessage = /*#__PURE__*/function () {
  var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee(event) {
    var _event$data, type, payload, _t, _t2, _t3, _t4;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function (_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 1:
          ...
          _t = type;
          _context.next = _t === 'TOGGLE_SCOUT' ? 2 : _t === 'SETTINGS_READY' ? 3 : 5;
          break;
        case 2:
        ...
        case 3:
          _t2 = postMessageToToolbarIframe;
          _context.next = 4;
...
const iframeResize = __webpack_require__(86)

module.exports = {
  iframeResize: iframeResize,
  iframeResizer: iframeResize, // Backwards compatibility
  contentWindow: __webpack_require__(87)
}
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _frame_js_content_utils_Platform__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(15);
/* harmony import */ var iframe_resizer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(73);
...
/* harmony import */ var _frame_js_content_scout_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(17);
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(22);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(34);
/* harmony import */ var _frame_js_content_utils_constants__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(1);
...
var openPermissionPopup = function openPermissionPopup(platformName) {
  var url = "enablePermission.html?platform=".concat(platformName);
  chrome.tabs.query({
    active: true,
    currentWindow: true
  }, function (tabs) {
    var activeTab = tabs.length ? tabs[0] : null;
    if (activeTab) {
      url += "&openerTab=".concat(activeTab.id);
    }
    chrome.tabs.create({
      url: url
    });
...
var renderPopupIframe = function renderPopupIframe(platformName) {
  document.getElementById(_constants__WEBPACK_IMPORTED_MODULE_5__[/* MINIMIZE_BUTTON_ID */ "a"]).onclick = function () {
    return window.close();
  };
  window.addEventListener('message', _utils__WEBPACK_IMPORTED_MODULE_6__[/* onToolbarIframeMessage */ "a"], false);
  Object(_frame_js_content_scout_utils__WEBPACK_IMPORTED_MODULE_4__[/* listenScoutPermissionChanges */ "b"])(_frame_js_content_utils_constants__WEBPACK_IMPORTED_MODULE_7__[/* FRAME_PLATFORMS */ "d"].TOOLBAR);
  var url = "".concat(_constants__WEBPACK_IMPORTED_MODULE_5__[/* TOOLBAR_IFRAME_URL */ "c"], "?platform=").concat(platformName);
  var iframe = document.getElementById(_constants__WEBPACK_IMPORTED_MODULE_5__[/* TOOLBAR_IFRAME_ID */ "b"]);
  iframe.setAttribute('src', url);
  Object(iframe_resizer__WEBPACK_IMPORTED_MODULE_3__["iframeResize"])({
    log: false,
    checkOrigin: false,
    heightCalculationMethod: 'lowestElement'
  }, "#".concat(_constants__WEBPACK_IMPORTED_MODULE_5__[/* TOOLBAR_IFRAME_ID */ "b"]));
};
var openToolbarPopup = /*#__PURE__*/function () {
  var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0___default()(/*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee() {
    var _yield$Platform$detec, platformName;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function (_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 1;
          return _frame_js_content_utils_Platform__WEBPACK_IMPORTED_MODULE_2__[/* Platform */ "a"].detect(true);
        case 1:
          _yield$Platform$detec = _context.sent;
          platformName = _yield$Platform$detec.name;
          if ([_frame_js_content_utils_constants__WEBPACK_IMPORTED_MODULE_7__[/* FRAME_PLATFORMS */ "d"].SALESFORCE_LIGHTNING].includes(platformName)) {
            chrome.tabs.query({
              active: true,
              currentWindow: true
            }, function (tabs) {
              chrome.tabs.sendMessage(tabs[0].id, {
                ...
                // No response, this means no content script was injected.
                // Open a tab for asking run time host permission.
                response ? renderPopupIframe(platformName) : openPermissionPopup(platformName);
              });
            });
          } else {
            renderPopupIframe(platformName);
          }
        case 2:
        case "end":
          return _context.stop();
  ...
  return function openToolbarPopup() {
    return _ref.apply(this, arguments);
  };
}();
openToolbarPopup();
